...
class TestImageValidation(unittest.TestCase):
    ...
    def test_is_image(self):
        ...
        self.assertTrue(iutil.is_image(self.IMAGE_FILE))
        self.assertFalse(iutil.is_image(self.TEXT_FILE))
    ...
    def test_does_extension_match(self):
        ...
        self.assertTrue(iutil.does_extension_match(self.IMAGE_FILE))
        self.assertFalse(iutil.does_extension_match(self.MISMATCHED_FILE))
    ...
    def test_fix_mismatched_extension(self):
        ...
        new_filepath = iutil.new_file_from_mimetype(self.MISMATCHED_FILE)
