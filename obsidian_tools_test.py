...
class TestObsidianTools(unittest.TestCase):
    ...
    def test_get_content(self):
        ...
        with open('test/test.md', 'r') as file:
            ...
            print(content)
            self.assertEqual(content, {'Example Header 1': {'Example Header 2': {'Example Header 3': ['List item 1', 'List item 2'], 'Example Header 3-1': 'This text should get captured.'}}})
    ...
    def test_ObsidianPageData(self):
        ...
        with open('test/test.md', 'r') as file:
            ...
            self.assertEqual(page.frontmatter, {'title': 'Example', 'tags': 'example, test'})
